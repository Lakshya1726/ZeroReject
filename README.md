...
- **Modern UI**: Build a responsive and intuitive user interface with React and Next.js, featuring a dark AR dashboard aesthetic.
...
1. **Clone the repository**:
   ```bash
   git clone https://github.com/Lakshya1726/ZeroReject.git
   cd CareerBoost-AI
