...
function AddNewInterview() {
  ...
  const InputPrompt = `Job Position: ${jobPosition}, Job Description: ${jobDesc}, Years of Experience: ${jobExperience}. Depends on Job Position, Job Description & Years of Experience, give me ${questionCount} interview questions along with answers in JSON format. Return ONLY a valid JSON array of objects with 'question' and 'answer' fields. Do not include any other text or markdown.`;
